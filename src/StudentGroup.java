...
public class StudentGroup implements StudentArrayOperation {
	...
	public void setStudents(Student[] students) {
			...
			this.students[i] = new Student(students[i].getId(), students[i].getFullName(), students[i].getBirthDate(), students[i].getAvgMark());// Add your implementation here
	}
	...
	public void addFirst(Student student) {
		...
		for(int i=0;i<students.length;i++)
			temp[i+1] = students[i];
		students = temp;// Add your implementation here
	}
...
int n=this.students.length;
	...
	public Student[] getByBirthDate(Date date) {
		...
		for(int i=0;i<students.length;i++)
			if(students[i].getBirthDate().equals(date))
				temp[count++] = students[i];
		return temp;// Add your implementation here
		return null;
	}
